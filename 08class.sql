...
--err Cannot insert duplicate key row in object 'dbo.countries_test_mbelko' with unique index 'UQ_countries_test_mbelko'.
insert
	into
	db_laba.dbo.countries_test_mbelko
select
...
DROP TABLE db_laba.dbo.customers_mbelko; 
...
-- err The CREATE UNIQUE INDEX statement terminated because a duplicate key was found
ALTER TABLE db_laba.dbo.employees   
ADD CONSTRAINT UQ_employees UNIQUE (job_title);

DROP TABLE db_laba.dbo.TransactionHistory_mbelko;
...
drop TABLE db_laba.dbo.TransactionHistory_01_mbelko;
 ...
 */
--
DROP TABLE db_laba.dbo.Namefield_mbelko;
 ...
 */
--
drop table db_laba.dbo.Salespeople_mbelko;
...
drop table db_laba.dbo.Salespeople_01_mbelko;
...
drop table db_laba.dbo.Salespeople_02_mbelko;
